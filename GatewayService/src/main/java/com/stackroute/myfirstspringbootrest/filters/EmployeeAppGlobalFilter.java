...
public class EmployeeAppGlobalFilter implements GlobalFilter {
...
//DataBufferFactory dataBuf = exchange.getResponse().bufferFactory();
//DataBuffer buf = dataBuf.wrap("Deepan".getBytes());
